...
Java_com_flowseal_tgwsproxy_byedpi_core_VpnProtector_nativeSetVpnService(
        JNIEnv *env,
        __attribute__((unused)) jclass clazz,
        jobject vpn_service) {
    vpn_protect_set_service(env, vpn_service);
}

JNIEXPORT void JNICALL
Java_com_flowseal_tgwsproxy_byedpi_core_VpnProtector_nativeClearVpnService(
        JNIEnv *env,
        __attribute__((unused)) jclass clazz) {
    vpn_protect_clear(env);
}

JNIEXPORT jint JNICALL
Java_com_flowseal_tgwsproxy_byedpi_core_ByeDpiProxy_jniCreateSocketWithCommandLine(
        JNIEnv *env,
...
JNIEXPORT jint JNICALL
Java_com_flowseal_tgwsproxy_byedpi_core_ByeDpiProxy_jniCreateSocket(
        JNIEnv *env,
        __attribute__((unused)) jobject thiz,
        jstring ip,
        jint port,
...
JNIEXPORT jint JNICALL
Java_com_flowseal_tgwsproxy_byedpi_core_ByeDpiProxy_jniStartProxy(
...
JNIEXPORT jint JNICALL
Java_com_flowseal_tgwsproxy_byedpi_core_ByeDpiProxy_jniStopProxy(
        __attribute__((unused)) JNIEnv *env,
        __attribute__((unused)) jobject thiz,
        jint fd) {
