...
import com.flowseal.tgwsproxy.byedpi.core.ByeDpiProxyUIPreferences
import com.flowseal.tgwsproxy.byedpi.core.ByeDpiProxyUIPreferences.DesyncMethod.*
import com.flowseal.tgwsproxy.byedpi.core.ByeDpiProxyUIPreferences.HostsMode.*
import com.flowseal.tgwsproxy.byedpi.utility.*
...
class ByeDpiUISettingsFragment : PreferenceFragmentCompat() {
    ...
    private fun updatePreferences() {
        val desyncMethod =
            findPreferenceNotNull<DropDownPreference>("byedpi_desync_method")
                .value.let { ByeDpiProxyUIPreferences.DesyncMethod.fromName(it) }
        val hostsMode = findPreferenceNotNull<DropDownPreference>("byedpi_hosts_mode")
